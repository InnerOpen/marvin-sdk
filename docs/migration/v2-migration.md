...
Complete migration guide for upgrading from Marvin SDK v1.x to v2.0.0.

## Breaking Changes Summary

Marvin SDK v2.0.0 introduces **schema-driven entry types**, transforming Marvin from a Markdown-centric CMS into a flexible, schema-driven content platform.
...
!!! info "Automatic Migration"
    The backend automatically migrated all existing `contentMarkdown` → `dataJson.body` during the v2.0.0 upgrade.
...
- **Documentation**: [Marvin SDK Docs](https://marvin-sdk.inneropen.com)
...
- [Breaking Changes](breaking-changes.md) - Detailed breaking changes list
